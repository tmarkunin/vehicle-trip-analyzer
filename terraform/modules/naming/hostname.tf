...
##############################
locals {
  // <appname><count>-<short_product>-<instance>-<env>-<short_region>.<subdomain>.<root> // https://confluence.acoustic.co/pages/viewpage.action?spaceKey=ACOUSMGN&title=Tagging+and+naming+convention+policies
